...
const client = redis.createClient({
  url: "redis://127.0.0.1:6379", // Porta de conexão com Redis
  socket: {
...
// Conectar ao MongoDB
mongoose.connect("mongodb://127.0.0.1:27017/primegaming", {});
...
app.listen(PORT, () => {
  console.log(`Aplicação está sendo executada em http://127.0.0.1:${PORT}`);
});
